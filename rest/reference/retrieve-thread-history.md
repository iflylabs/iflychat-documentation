...
1. Retrieving thread history of a room or list of rooms 
  ...
  **Curl Command**
  ...
  curl -H "Content-Type: application/json" -X POST https://api.iflychat.com/api/1.1/threads/get -d                                      "{\"api_key\":\"Wr4vpoJ_ET3lpBdX9E9TukjzDF62L-gc7RGzuZvKqZgW5\", \"room_id\": \"5\", \"start_timestamp\": \"1433142614\",             \"end_timestamp\": \"1433154346\", \"limit\": \"5\"}"
