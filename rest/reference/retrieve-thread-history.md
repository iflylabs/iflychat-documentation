...
1. Retrieving thread history of a room or list of rooms 
  ...
  **Curl Command**
  ...
  curl -H "Content-Type: application/json" -X POST https://api.iflychatdev.com/api/1.1/threads/get -d "{\"api_key\":                    \"Wr4vpoJ_ET3lpBdX9E9TutUic4Dgb-gc7RGzuZvKqZgW5\",  \"room_id\": \"5\", \"start_timestamp\": \"1433142614\", \"end_timestamp\":       \"1433154346\", \"limit\": \"3\"}" 
...
2. Retrieving thread history of a user or list of users 
  ...
  **Curl Command**
  ...
  curl -H "Content-Type: application/json" -X POST https://api.iflychatdev.com/api/1.1/threads/get -d "{\"api_key\":                    \"Wr4vpoJ_ET3lpBdX9E9TutUic4Dgb-gc7RGzuZvKqZgW5\",  \"user_id[0]\": \"5\", \"user_id[1]\" : \"6\", \"start_timestamp\":               \"1433142614\", \"end_timestamp\": \"1433154346\", \"limit\": \"3\", \"thread_filter\": \"room\"}" 
 ...
 **Curl Command**
 ...
 curl -H "Content-Type: application/json" -X POST https://api.iflychatdev.com/api/1.1/threads/get -d "{\"api_key\":                    \"Wr4vpoJ_ET3lpBdX9E9TutUic4Dgb-gc7RGzuZvKqZgW5\",  \"from_id\": \"5\", \"to_id\" : \"6\", \"start_timestamp\":                       \"1433142614\", \"end_timestamp\": \"1433154346\", \"limit\": \"3\"}"
